...
public class InterpolationInterarrivalTimeCreator extends SubComponentCreator {

    public String usage() {
	return "InterpolationInterarrivalTime(" +
	    "<Interpolation interpolationType>, <int numPoints>, " +
	    "<String fileName>)";
    }
	...
	try {
	    ...
	    InterpolationInterarrivalTime in = 
		new InterpolationInterarrivalTime();
