...
var ENDSHOW_MESG="スライド ショーの最後です。 クリックすると終了します。", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=25, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0026.htm", 1, 1),
   new hrefList("slide0040.htm", 1, 2),
   new hrefList("slide0036.htm", 1, 3),
   new hrefList("slide0035.htm", 1, 4),
   ...
   new hrefList("slide0047.htm", 1, 11),
   new hrefList("slide0048.htm", 1, 12),
   new hrefList("slide0012.htm", 1, 13),
   new hrefList("slide0002.htm", 1, 14),
   new hrefList("slide0019.htm", 1, 15),
   new hrefList("slide0008.htm", 1, 16),
   new hrefList("slide0031.htm", 1, 17),
   new hrefList("slide0034.htm", 1, 18),
   new hrefList("slide0033.htm", 1, 19),
   new hrefList("slide0032.htm", 1, 20),
   new hrefList("slide0042.htm", 1, 21),
   new hrefList("slide0041.htm", 1, 22),
   new hrefList("slide0045.htm", 1, 23),
   new hrefList("slide0006.htm", 1, 24),
